                                            ...
                                            <div class="col-md-6 mt-1">
                                                <div class="card shadow" style="width: 15rem;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @else
                                                            <p class="font-weight-bold small pt-4">Toko Tersedia <i class="fas fa-check text-success ml-1"></i></p>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-1">
                                                <div class="card shadow" style="width: 15rem;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">Goporodisa lebih mudah untuk menghubungi nomor telepon
                                                        </p>
                                                        @if($getPhone == null)
                                                            <a href="{{url('/halaman_profil/profil')}}" class="btn btn-primary mt-2 col-md-12">Tambah No Telepon</a>
                                                        @else
                                                            <p class="font-weight-bold small pt-4">Nomor Telepon Tersedia <i class="fas fa-check text-success ml-1"></i></p>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
